...
using unit_nautical_mile = dh::units::unit<dh::units::dimensions::length, ratio_nautical_mile, 1 >;
using unit_mile = dh::units::unit<dh::units::dimensions::length, ratio_mile, 1 >;
using unit_yard = dh::units::unit<dh::units::dimensions::length, ratio_yard, 1 >;
using unit_foot = dh::units::unit<dh::units::dimensions::length, ratio_foot, 1 >;
using unit_inch = dh::units::unit<dh::units::dimensions::length, ratio_inch, 1 >;
...
using unit_pound = dh::units::unit<dh::units::dimensions::mass, ratio_pound, 1 >;
using unit_ounce = dh::units::unit<dh::units::dimensions::mass, ratio_ounce, 1 >;
using unit_fahrentheit = dh::units::unit<dh::units::dimensions::degree_fahrenheit, std::ratio<1,1>, 1 >;


DH_DECLARE_QUANTITY( nautical_mile, unit_nautical_mile )
